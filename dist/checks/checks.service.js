...
let ChecksService = class ChecksService {
    ...
    async create(createCheckDto) {
        console.log(...oo_oo(`578825578_11_4_11_44_4`, 'llegamos a create service'));
        console.log(...oo_oo(`578825578_12_6_12_51_4`, 'createCheckDto', createCheckDto));
    ...
    async findAll() {
        console.log(...oo_oo(`578825578_119_4_119_34_4`, 'findAll service'));
        const client = await this.databaseService.getClient();
        try {
            const { rows: checks } = await client.query(`SELECT * FROM public.checks`);
            console.log(...oo_oo(`578825578_123_6_123_35_4`, 'checks', checks));
            return checks;
        }
        catch (error) {
            throw error;
    ...
    async findOne(id) {
        console.log(...oo_oo(`578825578_133_4_133_45_4`, "entramos a findOne service"));
        const client = await this.databaseService.getClient();
        try {
            const { rows: check } = await client.query(`SELECT * FROM public.checks WHERE id = $1`, [id]);
            console.log(...oo_oo(`578825578_137_6_137_33_4`, 'check', check));
            return check[0];
        }
        catch (error) {
            throw error;
    ...
    async getMovements(id) {
        console.log(...oo_oo(`578825578_310_4_310_39_4`, 'getMovements service'));
        const client = await this.databaseService.getClient();
        try {
